...
@Suite struct RV32iMemTests {
    ...
    func loadMemory(_ instr: UInt32, _ x2: Int64, _ imm: Int64, _ nBytes: Int, _ unsign: Bool) throws {
        ...
        switch nBytes {
        case 1: // 1 bytes
            resNumber = unsign ? Int64(0x85) : Int64(Int8(bitPattern: 0x85))
            mstate = mstate.setMemoryByte(memAddr, 0x85)
        case 2: // 2 bytes
            resNumber = unsign ? Int64(0xa10f) : Int64(Int16(bitPattern: 0xa10f))
            mstate = mstate.setMemoryByte(memAddr, 0x0f)
            mstate = mstate.setMemoryByte(memAddr + 1, 0xa1)
        default: // 4 bytes
            resNumber = Int64(Int32(bitPattern: 0xc3b2a10f))
            mstate = mstate.setMemoryByte(memAddr, 0x0f)
            mstate = mstate.setMemoryByte(memAddr + 1, 0xa1)
    ...
    func storeMemory(_ instr: UInt32, _ x3: Int64, _ x2: Int64, _ imm: Int64, _ nBytes: Int) throws {
        ...
        switch nBytes {
        case 1: // 1 bytes
            memoryRes = Int64(loadByte(mstate.Memory, memAddr)!)
        case 2: // 2 bytes
